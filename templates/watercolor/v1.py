...
result = client.predict(
		"samarth.jpeg",	# filepath  in 'Upload a photo of your face' Image component
		"bp1.jpg",	# filepath  in 'Upload a reference pose image (Optional)' Image component
		"a man standing and looking above",	# str  in 'Prompt' Textbox component
		...
		"Watercolor",	# Literal['(No style)', 'Spring Festival', 'Watercolor', 'Film Noir', 'Neon', 'Jungle', 'Mars', 'Vibrant Color', 'Snow', 'Line art']  in 'Style template' Dropdown component
		30,	# float (numeric value between 1 and 100) in 'Number of sample steps' Slider component
		...
		5.0,	# float (numeric value between 0.1 and 20.0) in 'Guidance scale' Slider component
