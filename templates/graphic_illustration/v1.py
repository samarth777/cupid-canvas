...
result = client.predict(
		"girl.jpeg",	# filepath  in 'Upload a photo of your face' Image component
		"gp1.png",	# filepath  in 'Upload a reference pose image (Optional)' Image component
		"boy standing,  comic, graphic illustration, comic art, graphic novel art, vibrant, highly detailed, colored, 2d minimalistic",	# str  in 'Prompt' Textbox component
