...
result = client.predict(
		...
		"ethereal fantasy concept art of {prompt} . magnificent, celestial, ethereal, painterly, epic, majestic, magical, fantasy art, cover art, dreamy",	# str  in 'Prompt' Textbox component
